...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <a class="item-nav" href="login.jsp">INGRESAR</a>
    </div>
  </div>
</nav>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <h2>Bienvenido</h2>
    <p id="parrafo-registro">Registrate y vivi la experiencia trust bank</p>
    ...
    <!-- tercera imagen -->
    <div class="carousel-item">
      <img class="d-block w-100" src="img/notebook2.jpg" alt="Third slide">
      <div class="carousel-caption d-none d-md-block">
    <h2>Trasferencias</h2>
    <p id="parrafo-registro">¡Tranferir dinero nunca fue tan fácil!</p>
