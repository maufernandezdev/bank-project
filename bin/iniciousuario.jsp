...
<!-- header -->
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    <div class="navbar-nav ml-auto ml-auto text-center">
      ...
      <a class="item-nav" href="index.jsp">CERRAR SESIӓN</a>
...
<div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="perfilusuario.jsp" class="list-group-item list-group-item-action bg-light"><i class="fas fa-address-card"></i> Informaci�n personal</a>
      </div>
    </div>
...
<!-- cuentas -->    
  ...
  <li class="nav-item">
    <a class="nav-link active" href="#">Cuenta 1</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#">Cuenta 2</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#">Cuenta 3</a>
  </li>
</ul>
