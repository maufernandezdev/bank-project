	...
	<div id="layoutSidenav">
		<div id="layoutSidenav_nav">
			...
			<div class="sb-sidenav-footer">
				<div class="small">
					Logueado como:<label>${userconect.usuario}</label>
				</div>
			...
			<div class="container-fluid">
				<form>
					<div class="form-group">
						<label for="nombre">Ingrese el nombre de usuario:</label> <input
					...
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" value="" id="radio2"
							name="grupo2"> <label class="form-check-label"
							for="radio2"> Cuenta corriente </label>
					</div>
					<br>

					<div class="form-group">
						<label for="nrocuenta">Nro de cuenta:</label> <input type="text"
							class="form-control" id="Nrodecuenta" name="Nrodecuenta">
					</div>
					<div class="form-group">
						<label for="CBU">CBU:</label> <input type="text"
							class="form-control" id="CBU" name="CBU">
					</div>
					<button type="submit"
						class="btn w-100 btn-warning rounded-pill mt-5">Asignar
						cuenta</button>
				</form>
			</div>
			</main>
